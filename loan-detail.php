...
if(!$laptopData->num_rows) redirect("/loan");

$result = $laptopData->fetch_assoc();
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="btn-group">
              <a href="<?=base_url('/loan') ?>" class="btn btn-light">Back</a>

              <?php if($result['ready'] AND $result['condition'] === 'normal') : ?>
              <a href="<?=base_url("loan/{$result['id']}/add") ?>" class="btn btn-primary">Loan</a>
              <?php else : ?>
          ...
          <div class="table-responsive">
            <table class="table table-striped">
              <tbody>
                ...
                <tr>
                  <th>Price</th>
                  <td><?=numberAbbr($result['price']); ?> IDR / Day</td>
                </tr>
                <tr>
                  ...
                  <td>
                    ...
                    <span class="<?=$condition[$result['condition']]['badge'] ?>"><?=$condition[$result['condition']]['name'] ?></span> / <span class="<?=$ready[$result['ready']]['badge'] ?>"><?=$ready[$result['ready']]['name'] ?></span></td>
                </tr>
              </tbody>
            </table>
          </div>
